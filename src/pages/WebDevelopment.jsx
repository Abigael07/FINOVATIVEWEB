...
const WA = 'https://wa.me/254704955384?text=Hello%2C%20I%20want%20to%20build%20a%20website%20with%20Finovative';
    ...
    <div style={{ background: 'var(--navy)' }}>
      ...
      <section style={{ padding: isMobile ? '60px 20px' : '80px 60px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: '1.8rem', fontWeight: 300, color: 'var(--white)', marginBottom: '40px' }}>Our Services</h2>
      ...
      <section style={{ padding: isMobile ? '0 20px 60px' : '0 60px 80px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: '1.8rem', fontWeight: 300, color: 'var(--white)', marginBottom: '40px' }}>Projects</h2>
      ...
      {/* CTA */}
      <section style={{ padding: isMobile ? '60px 20px' : '80px 60px', background: 'var(--navy-panel)', borderTop: '1px solid var(--blue-edge)', textAlign: 'center' }}>
