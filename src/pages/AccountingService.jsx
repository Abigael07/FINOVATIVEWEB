    ...
    <div style={{ background: 'var(--navy)' }}>
      ...
      <section style={{ padding: isMobile ? '60px 20px' : '80px 60px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '14px' }}>
                  <div style={{
                    ...
                    <span style={{ fontSize: '0.6rem', letterSpacing: '0.1em', color: 'var(--blue-bright)', fontFamily: 'var(--font-sans)' }}>
          ...
          >
            <div>
              <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: isMobile ? '1.6rem' : '2rem', fontWeight: 300, color: 'var(--white)', marginBottom: '10px' }}>
                Ready to get your accounts in order?
              </h2>
              <p style={{ fontSize: '0.85rem', color: 'var(--white-dim)', lineHeight: 1.7, fontFamily: 'var(--font-sans)', fontWeight: 300 }}>
                Fill in our enrolment form and we'll get back to you within 24 hours to discuss the right package for your business.
              </p>
            </div>

            {/* ── Enroll Now → /enroll ── */}
            <Link to="/enroll" style={{ flexShrink: 0 }}>
              <motion.button
