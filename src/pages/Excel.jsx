  ...
  return (
    <div style={{ background: 'var(--navy)' }}>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: isMobile ? '60px 20px' : '80px 60px' }}>
        ...
        >
          <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: '1.5rem', fontWeight: 300, color: 'var(--white)', marginBottom: '20px' }}>
            What You Will Learn
          </h2>
        ...
        <motion.div
          ...
          style={{
            ...
            padding: isMobile ? '40px 28px' : '52px 60px',
            textAlign: 'center',
          }}
        >
          <p style={{ fontSize: '0.65rem', letterSpacing: '0.3em', color: 'var(--blue-bright)', textTransform: 'uppercase', fontFamily: 'var(--font-sans)', marginBottom: '12px' }}>
            Course Fee
          </p>
          <p style={{ fontFamily: 'var(--font-serif)', fontSize: '3.2rem', fontWeight: 300, color: 'var(--white)', marginBottom: '28px', lineHeight: 1 }}>
            KES 10,000
          </p>
